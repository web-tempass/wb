...
const sendEmail = (e) =>{
    e.preventDefault()
    emailjs.sendForm('service_hbgp846', 'template_4az2bev','#contact-form','kh5nucPMicXqUn6aD')
    .then(()=>{
        contactMessage.textContent = 'Envio Bem Sucedido ✅'
...
// teste adicionar somente um produto ao carrinho sem repetição
function addCart($idProduct){
    let productsCopy = JSON.parse(JSON.stringify(products));
